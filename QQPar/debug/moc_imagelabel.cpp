...
QT_MOC_LITERAL(1, 11, 13), // "dragInitiated"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "ImageLabel\0dragInitiated\0"
};
...
void ImageLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dragInitiated(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageLabel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageLabel::dragInitiated)) {
                *result = 0;
                return;
            }
        }
