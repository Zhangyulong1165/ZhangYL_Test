...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QColorPicker_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QColorPicker_t qt_meta_stringdata_QColorPicker = {
    {
QT_MOC_LITERAL(0, 0, 12), // "QColorPicker"
QT_MOC_LITERAL(1, 13, 14), // "onColorClicked"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 18) // "onThicknessClicked"

    },
    "QColorPicker\0onColorClicked\0\0"
    "onThicknessClicked"
};
...
void QColorPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onThicknessClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject QColorPicker::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QColorPicker.data,
    qt_meta_data_QColorPicker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QColorPicker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QColorPicker.stringdata0))
