/****************************************************************************
** Meta object code from reading C++ file 'WebId.h'
**
...
#include "../../Tbkt/WebId.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'WebId.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 9, 8), // "jscallme"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 7), // "msgtype"
QT_MOC_LITERAL(4, 27, 3) // "msg"

    },
    "WebClass\0jscallme\0\0msgtype\0msg"
};
...
void WebClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WebClass *_t = static_cast<WebClass *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->jscallme((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}

const QMetaObject WebClass::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WebClass.data,
      qt_meta_data_WebClass,  qt_static_metacall, nullptr, nullptr}
};
