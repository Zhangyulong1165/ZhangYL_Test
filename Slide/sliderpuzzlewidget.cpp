...
void SliderPuzzleWidget::initForm()
{
    ...
    ui.puzzlewidget->setPixmap(":/FrmSlidePuzzleWidget/Resources/tu1.png");
}
...
void SliderPuzzleWidget::onSliderReleased()
{
    ...
    testIndex = testIndex + 1 > 2 ? 1 : testIndex + 1;
	ui.horizontalSlider->setValue(0);
    ui.puzzlewidget->setPixmap(QString(":/FrmSlidePuzzleWidget/Resources/tu%1.png").arg(testIndex));
}
