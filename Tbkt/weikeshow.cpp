...
weikeshow::weikeshow(QObject *parent) : QObject(parent)
{

}
QString weikeshow::chaeakweike()
{
...
//qDebug() << "student_list:" << subObj.value("student_list").toString();
     ...
     is_display_micro_lesson = subObj.value("is_display_micro_lesson").toString();
//                           QString bol = subObj.value(lab).toString();
qDebug()<<"is_display_micro_lesson*********:"<<is_display_micro_lesson;

}
        return is_display_micro_lesson;
}
