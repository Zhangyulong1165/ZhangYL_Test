...
void huaban_Form::on_pushButton_huabanright_clicked()
{
    ...
    if (i == 4)
    {
        ...
        ui->pushButton_huabanright->setStyleSheet("QPushButton{background:/new/prefix1/Images/指向-right (1).png}");
    }
    //qDebug() <<"i1:"<< i;
}
//左切换画板页
void huaban_Form::on_pushButton_huabanleft_clicked()
{
    ...
    if(i>0){
        ...
        {
            ui->pushButton_huabanleft->setEnabled(false);
            ui->pushButton_huabanleft->setStyleSheet("QPushButton{background:qrc:/new/prefix1/Images/指向-left.png}");
            i = 0;
        }
    }
    else{
